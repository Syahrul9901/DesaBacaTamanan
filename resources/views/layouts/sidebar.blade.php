<div class="sidebar p-3">
    ...
    <div class="text-center mb-4 pb-3 border-bottom border-white">
        ...
        <small class="text-white-50">{{ Auth::user()->is_admin ? 'Administrator' : 'Anggota' }}</small>
    </div>
    
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link text-white rounded py-2" href="{{ route('admin.dashboard') }}">
                <i class="bi bi-speedometer2 me-2"></i> <span class="d-none d-lg-inline">Dashboard</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white rounded py-2" href="{{ route('admin.books.index') }}">
                <i class="bi bi-book me-2"></i> <span class="d-none d-lg-inline">Kelola Buku</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white rounded py-2" href="{{ route('admin.borrowings.index') }}">
                <i class="bi bi-arrow-left-right me-2"></i> <span class="d-none d-lg-inline">Peminjaman</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white rounded py-2" href="{{ route('admin.users.index') }}">
                <i class="bi bi-people me-2"></i> <span class="d-none d-lg-inline">User</span>
            </a>
        </li>
    </ul>
